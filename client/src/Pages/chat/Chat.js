            ...
            <div className="flex flex-col justify-between flex-1 mt-6">
              <nav className="-mx-3 space-y-6 ">
                <div className="space-y-3 ">
                  ...
                  {projects.map(
                    (project) => {
                      return <a key={project._id} onClick={() => {
                        setMessages([...project.messages])
                        setRoom(project._id)
                      }} className="flex items-center px-3 py-2 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700" href={"#" + project.name}>
        ...
        <div className="flex-1 p-2 sm:p-6 justify-between flex flex-col h-screen">
          <div id="messages" className="flex flex-col space-y-4 p-3 overflow-y-auto scrollbar-thumb-blue scrollbar-thumb-rounded scrollbar-track-blue-lighter scrollbar-w-2 scrolling-touch">
            ...
            {messages
              .map((message) => {
                console.log(message);
                return (user && message.user_id !== user._id) ? <div className="chat-message" key={message._id}>
                ...
                </div> : <div className="chat-message" key={message._id}>
